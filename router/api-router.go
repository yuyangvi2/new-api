...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.POST("/media/upload", middleware.UserAuth(), middleware.UploadRateLimit(), controller.UploadMedia)
		toapisPrivateAvatarRoute := apiRouter.Group("/toapis/private-avatar")
		toapisPrivateAvatarRoute.Use(middleware.UserAuth())
		{
		...
		apiRouter.GET("/verification", middleware.EmailVerificationRateLimit(), middleware.BotProtectionCheck(middleware.BotProtectionSceneRegister), controller.SendEmailVerification)
		apiRouter.GET("/reset_password", middleware.CriticalRateLimit(), middleware.BotProtectionCheck(middleware.BotProtectionSceneLogin), controller.SendPasswordResetEmail)
		...
		apiRouter.POST("/official/alipay/notify", anonymousRequestBodyLimit, controller.OfficialAlipayNotify)
		apiRouter.GET("/official/alipay/notify", controller.OfficialAlipayNotify)
		apiRouter.GET("/official/alipay/return", controller.OfficialAlipayReturn)
		apiRouter.POST("/official/alipay/return", anonymousRequestBodyLimit, controller.OfficialAlipayReturn)
		apiRouter.POST("/official/wechat-pay/notify", anonymousRequestBodyLimit, controller.OfficialWeChatPayNotify)
		...
		{
			userRoute.POST("/register", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, middleware.BotProtectionCheck(middleware.BotProtectionSceneRegister), controller.Register)
			userRoute.POST("/login", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, middleware.BotProtectionCheck(middleware.BotProtectionSceneLogin), controller.Login)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/payment/status", controller.OfficialPaymentStatus)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.POST("/invoice/delete", controller.AdminDeleteInvoices)
