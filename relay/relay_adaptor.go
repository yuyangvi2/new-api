...
import (
	...
	taskseedancem "github.com/QuantumNous/new-api/relay/channel/task/seedancem"
	tasksora "github.com/QuantumNous/new-api/relay/channel/task/sora"
	"github.com/QuantumNous/new-api/relay/channel/task/suno"
	tasktoapis "github.com/QuantumNous/new-api/relay/channel/task/toapis"
	...
	taskvodaigc "github.com/QuantumNous/new-api/relay/channel/task/vodaigc"
...
func GetTaskAdaptor(platform constant.TaskPlatform) channel.TaskAdaptor {
	...
	if channelType, err := strconv.ParseInt(string(platform), 10, 64); err == nil {
		...
		case constant.ChannelTypeSeedanceOfficial:
			return &taskdoubao.SeedanceOfficialTaskAdaptor{}
		...
		case constant.ChannelTypeVCLM:
			return &taskvclm.TaskAdaptor{}
		case constant.ChannelTypeVODAIGC:
			return &taskvodaigc.TaskAdaptor{}
		...
		case constant.ChannelTypeToAPIs:
			return &tasktoapis.TaskAdaptor{}
		case constant.ChannelTypeSeedanceM:
			return &taskseedancem.TaskAdaptor{}
		}
	}
	return nil
}
