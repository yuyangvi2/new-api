...
export const STATIC_I18N_KEYS = [
  ...
  'Frontier Reasoning',
  'Fable 5.1',
  'Powerful reasoning and coding for complex projects, long-running tasks, and production agents.',
  'GPT-6 Astra',
  'The latest flagship model for advanced reasoning, coding, and agentic workflows.',
  'Grok 4.6',
  'Advanced reasoning',
  'Coding',
  'Agents',
  ...
  'Go to slide {{index}}',
  'Authorized Partners',
  'Official model authorization',
  'Direct source access, real-time sync, stable and reliable',
  '{{count}} models',
  'No model data',
  '18 models',
  '4 models',
  ...
  'Model Marketplace',
  'Find the right AI model by task, provider, and capability',
  'Browse available models, compare capabilities, and quickly enter the integration path.',
  'Choose the right model before you write integration code',
  ...
  'Providers',
  'Available models',
  'Choose a text, image, video, or audio model first.',
  'Models',
  'Showing',
  'Showing {{start}}-{{end}} of {{total}} models',
  'Search model, task, or provider',
  'Text',
  'Audio',
  ...
  'Integration guide',
  'Integration path',
  'From selection to stable traffic',
  ...
  'Supported model signals',
  'Supported endpoints',
  'Capability tags',
  'Pricing, performance, and API contract',
  'Inspect the model before production rollout',
  'Use the tabs below to inspect pricing rules, live performance signals, and compatible API paths.',
  'Start with the compatible endpoint',
  'Use the supported endpoint list below to decide whether this model should run through chat, response, image, audio, or video APIs.',
  'Check cost before production traffic',
  'Review base price and group pricing first, especially for long context, image, audio, or video workloads.',
  'Validate prompts with a small batch',
  'Run a few representative requests, then tune output length, streaming, retries, and fallback routing.',
  'Model signals',
  'No endpoint data yet',
  'No capability tags yet',
  ...
  'or',
  'Ready to start?',
  'Ready to unify access to AI models?',
  'Use one compatible API to connect models, billing, routing, and operations.',
  'Start now',
  'View models',

  // ToAPIs-style public footer
  'Built for unified AI model access, billing, and operations.',
  'Product',
  'Model services',
  'API Reference',
  'Resources',
