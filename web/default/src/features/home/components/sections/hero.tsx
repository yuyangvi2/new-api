...
export function Hero(props: HeroProps) {
  ...
  return (
    <section className='relative z-10 overflow-hidden px-6 pt-24 pb-16 md:pt-32 md:pb-24 lg:pt-36 lg:pb-28'>
      {/* Subtle single-hue accent glow (DESIGN.md: 蓝为点睛，不用彩色渐变) */}
      <div
        aria-hidden
        className='pointer-events-none absolute inset-0 -z-10 opacity-[0.06] dark:opacity-[0.10]'
        style={{
          background:
            'radial-gradient(ellipse 55% 45% at 25% 15%, #2d4bff 0%, transparent 70%)',
        }}
      />
      {/* Grid pattern */}
      <div
      ...
      <div className='mx-auto grid max-w-6xl grid-cols-1 items-start gap-12 lg:grid-cols-12 lg:gap-8'>
        ...
        <div className='flex flex-col items-start text-left lg:col-span-6'>
          {/* Top Pill Badge */}
          <div
            className='landing-animate-fade-up text-brand border-brand/20 bg-brand/5 mb-5 inline-flex items-center gap-1.5 rounded-full border px-3 py-1.5 text-[11px] font-medium opacity-0 shadow-xs'
