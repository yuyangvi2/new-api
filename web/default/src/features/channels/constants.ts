...
export const WANJIE_FANGZHOU_MODELS = [
  'qwen3-32b',
  'qwen3-235b',
  'qwen3-coder',
  'qwen3-next',
...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  9005: 'Bearer API key',
  9006: 'Bearer API key for SeedanceM',
  9007: 'Format: SecretId|SecretKey',
  10001: 'Bearer API key for Seedance Official',
}
