    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          OfficialAlipayAppID: settings.OfficialAlipayAppID,
          OfficialAlipayPrivateKey: settings.OfficialAlipayPrivateKey,
          OfficialAlipayPublicKey: settings.OfficialAlipayPublicKey,
          OfficialAlipayGateway: settings.OfficialAlipayGateway,
          OfficialWeChatPayAppID: settings.OfficialWeChatPayAppID,
          OfficialWeChatPayMchID: settings.OfficialWeChatPayMchID,
          OfficialWeChatPayMchSerialNo: settings.OfficialWeChatPayMchSerialNo,
          OfficialWeChatPayAPIv3Key: settings.OfficialWeChatPayAPIv3Key,
          OfficialWeChatPayPrivateKey: settings.OfficialWeChatPayPrivateKey,
          OfficialWeChatPayPlatformPublicKey:
            settings.OfficialWeChatPayPlatformPublicKey,
