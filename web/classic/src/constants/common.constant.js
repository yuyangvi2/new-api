...
export const TASK_ACTION_VCLM_IMAGE_TO_VIDEO = 'SubmitImageToVideoJob';
export const TASK_ACTION_VCLM_TEXT_TO_VIDEO = 'SubmitTextToVideoJob';
export const TASK_ACTION_VCLM_GENERAL_IMAGE_TO_VIDEO =
  'SubmitImageToVideoGeneralJob';
export const TASK_ACTION_VCLM_HUNYUAN_VIDEO = 'SubmitHunyuanToVideoJob';
export const TASK_ACTION_VCLM_VIDU_IMAGE_TO_VIDEO = 'SubmitImageToVideoViduJob';
export const TASK_ACTION_VCLM_VIDU_TEXT_TO_VIDEO = 'SubmitTextToVideoViduJob';
