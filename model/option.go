...
func InitOptionMap() {
	...
	common.OptionMap["billing_setting.billing_mode"] = billing_setting.BillingMode2JSONString()
	common.OptionMap["billing_setting.billing_expr"] = billing_setting.BillingExpr2JSONString()
